def main(ctx):
    ...
    image_name = "alpine"
    all_image_tags_arches = [{'tags': ['3.7'], 'arches': ['arm64v8', 'arm32v6', 'amd64'], 'dockerfile': 'alpine'}, {'tags': ['3.8'], 'arches': ['arm64v8', 'arm32v6', 'amd64'], 'dockerfile': 'alpine'}, {'tags': ['3.9'], 'arches': ['arm64v8', 'arm32v7', 'arm32v6', 'amd64'], 'dockerfile': 'alpine'}, {'tags': ['edge'], 'arches': ['arm64v8', 'arm32v7', 'arm32v6', 'amd64'], 'dockerfile': 'alpine'}, {'tags': ['latest', '3.10'], 'arches': ['arm64v8', 'arm32v7', 'arm32v6', 'amd64'], 'dockerfile': 'alpine'}]
